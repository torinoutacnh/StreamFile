...
{
    public partial class streamfiletest : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Crypto = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PasswordNotHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Temp2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Temp3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastCheckTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
